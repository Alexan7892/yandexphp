...
class DiskClientTest extends TestCase
{
    ...
    {
        $href                 = '/test/';
        $xml                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/directory-contents.xml');
    ...
    {
        $xml                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/disk-space-info.xml');
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($xml));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
            ->getMock();
    ...
    public function testSetPropertyResponse()
    {
        ...
        $prop                 = 'myprop';
        $value                = 'myvalue';
        $xml                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/set-property.xml');
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($xml));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
            ->getMock();
    ...
    public function testSetPropertyIncorrectStatusResponse()
    {
        ...
        $xml                  = file_get_contents(
            __DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/set-property-incorrect-status.xml'
        );
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($xml));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
    ...
    public function testGetPropertyResponse()
    {
        ...
        $prop                 = 'myprop';
        $value                = 'myvalue';
        $xml                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/get-property.xml');
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($xml));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
            ->getMock();
    ...
    public function testGetPropertyIncorrectStatusResponse()
    {
        ...
        $value                = 'myvalue';
        $xml                  = file_get_contents(
            __DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/get-property-incorrect-status.xml'
        );
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($xml));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
    ...
    {
        $login                = 'test.user';
        $txt                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/get-login.txt');
    ...
    public function testGetFileResponse()
    {
        $path                 = '/test/test.txt';
        $content              = 'test';
        $txt                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/get-file.txt');
    ...
    public function testDownloadFileResponse()
    {
        ...
        $destination          = '';
        $name                 = 'test.txt';
        $txt                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/test.txt');
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($txt));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
            ->getMock();
    ...
    public function testUploadFile()
    {
        ...
        $sourcePath           = __DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/test.txt';
        $fixtureFileData      = [
    ...
    public function testStartPublishing()
    {
        ...
        $xml                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/start-publishing.xml');
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($xml));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
            ->getMock();
    ...
    public function testCheckPublishing()
    {
        $path                 = '/test/test.txt';
        $link                 = 'https://yadi.sk/i/6dZVYPKCqCcYR';
        $xml                  = file_get_contents(__DIR__ . 'DiskClientTest.php/' . $this->fixturesFolder . '/check-publishing.xml');
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($xml));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
            ->getMock();
