...
class DictionaryClientTest extends TestCase
{
    ...
    public function testGetLanguages()
    {
        $json                 = file_get_contents(
            __DIR__ . 'DictionaryClientTest.php/' . $this->fixturesFolder . '/get-languages-response.json'
        );
    ...
    public function testLookupText()
    {
        ...
        $translation          = 'привет';
        $json                 = file_get_contents(
            __DIR__ . 'DictionaryClientTest.php/' . $this->fixturesFolder . '/lookup-response.json'
        );
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
    ...
    public function testLookupOtherText()
    {
        ...
        $translation          = 'поиск';
        $json                 = file_get_contents(
            __DIR__ . 'DictionaryClientTest.php/' . $this->fixturesFolder . '/lookup-response2.json'
        );
        $response             = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $guzzleHttpClientMock = $this->getMockBuilder(GuzzleHttpClient::class)
            ->setMethods(['request'])
