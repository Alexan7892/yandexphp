...
class PartnerClientTest extends TestCase
{
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-campaigns.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-logins.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-orders.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-stats.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-balance.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-settings.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-outlets.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-outlet.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-order-for-update-delivery.json');
        $jsonObj = json_decode($json);
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-region.json');
        $jsonObj = json_decode($json);
    ...
    {
        $json = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/set-order-status-response.json');
        $jsonObj = json_decode($json);
    ...
    {
        $fixture = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-model.json');
    ...
    {
        $fixture = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/find-models.json');
        $fixtureJson = json_decode($fixture);
    ...
    {
        $fixture = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-models.json');
        $fixtureJson = json_decode($fixture);
    ...
    {
        $fixture = file_get_contents(__DIR__ . 'PartnerClientTest.php/' . $this->fixturesFolder . '/get-model-offers.json');
        $fixtureJson = json_decode($fixture);
