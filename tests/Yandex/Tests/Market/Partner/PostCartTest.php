...
class PostCartTest extends TestCase
{
    ...
    {
        $json = file_get_contents(__DIR__ . 'PostCartTest.php/' . $this->fixturesFolder . '/post-cart-request-from-market.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PostCartTest.php/' . $this->fixturesFolder . '/post-cart-response-to-market.json');
