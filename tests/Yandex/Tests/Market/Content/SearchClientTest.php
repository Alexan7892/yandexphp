...
class SearchClientTest extends TestCase
{
    ...
    function testGet()
    {
        $json = file_get_contents(__DIR__ . 'SearchClientTest.php/' . $this->fixturesFolder . '/search.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'SearchClientTest.php/' . $this->fixturesFolder . '/search-filter-category-models.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        ...
        $json = file_get_contents(__DIR__ . 'SearchClientTest.php/' . $this->fixturesFolder . '/search-filter-category-offers.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
