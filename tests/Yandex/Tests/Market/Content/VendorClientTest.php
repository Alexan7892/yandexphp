...
class VendorClientTest extends TestCase
{
    ...
    {
        $json = file_get_contents(__DIR__ . 'VendorClientTest.php/' . $this->fixturesFolder . '/vendor-list.json');
    ...
    function testGet()
    {
        $json = file_get_contents(__DIR__ . 'VendorClientTest.php/' . $this->fixturesFolder . '/vendor.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'VendorClientTest.php/' . $this->fixturesFolder . '/vendor-match.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
