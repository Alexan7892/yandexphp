...
class ShopClientTest extends TestCase
{
    ...
    function testGet()
    {
        $json = file_get_contents(__DIR__ . 'ShopClientTest.php/' . $this->fixturesFolder . '/shop.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'ShopClientTest.php/' . $this->fixturesFolder . '/shop-match.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ShopClientTest.php/' . $this->fixturesFolder . '/shop-outlets.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ShopClientTest.php/' . $this->fixturesFolder . '/shop-opinions.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
