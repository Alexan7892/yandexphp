...
class CategoryClientTest extends TestCase
{
    ...
    {
        $json = file_get_contents(__DIR__ . 'CategoryClientTest.php/' . $this->fixturesFolder . '/category-list.json');
    ...
    function testGet()
    {
        $json = file_get_contents(__DIR__ . 'CategoryClientTest.php/' . $this->fixturesFolder . '/category.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'CategoryClientTest.php/' . $this->fixturesFolder . '/category-children.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'CategoryClientTest.php/' . $this->fixturesFolder . '/category-models.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'CategoryClientTest.php/' . $this->fixturesFolder . '/category-filters.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
