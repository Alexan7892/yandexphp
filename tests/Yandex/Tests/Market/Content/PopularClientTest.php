...
class PopularClientTest extends TestCase
{
    ...
    {
        $json = file_get_contents(__DIR__ . 'PopularClientTest.php/' . $this->fixturesFolder . '/popular-models.json');
    ...
    {
        $json = file_get_contents(__DIR__ . 'PopularClientTest.php/' . $this->fixturesFolder . '/popular-category-models.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
