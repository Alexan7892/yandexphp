...
class ModelClientTest extends TestCase
{
    ...
    function testGet()
    {
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-single.json');
        ...
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-parent.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        ...
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-child.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        ...
        // visual model
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-visual.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-info.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-offers.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-outlets.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-reviews.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-match.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'ModelClientTest.php/' . $this->fixturesFolder . '/model-opinions.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
