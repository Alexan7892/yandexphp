...
class GeoRegionClientTest extends TestCase
{
    ...
    {
        $json = file_get_contents(__DIR__ . 'GeoRegionClientTest.php/' . $this->fixturesFolder . '/georegion-list.json');
    ...
    function testGet()
    {
        $json = file_get_contents(__DIR__ . 'GeoRegionClientTest.php/' . $this->fixturesFolder . '/georegion.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'GeoRegionClientTest.php/' . $this->fixturesFolder . '/georegion-children.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'GeoRegionClientTest.php/' . $this->fixturesFolder . '/georegion-match.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
    ...
    {
        $json = file_get_contents(__DIR__ . 'GeoRegionClientTest.php/' . $this->fixturesFolder . '/georegion-shops-summary.json');
        $jsonObj = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
