...
class DatabaseTest extends TestCase
{
    ...
    {
        $json     = file_get_contents(__DIR__ . 'DatabaseTest.php/' . $this->fixturesFolder . '/get-databases.json');
    ...
    {
        $json     = file_get_contents(__DIR__ . 'DatabaseTest.php/' . $this->fixturesFolder . '/get-databases-filtered.json');
        $jsonObj  = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $dataSyncClientMock = $this->getMockBuilder(DataSyncClient::class)
            ->setMethods(['sendRequest'])
    ...
    {
        $json     = file_get_contents(__DIR__ . 'DatabaseTest.php/' . $this->fixturesFolder . '/update-database-title.json');
        $jsonObj  = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $dataSyncClientMock = $this->getMockBuilder(DataSyncClient::class)
            ->setMethods(['sendRequest'])
    ...
    {
        $json     = file_get_contents(__DIR__ . 'DatabaseTest.php/' . $this->fixturesFolder . '/get-database.json');
        $jsonObj  = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $dataSyncClientMock = $this->getMockBuilder(DataSyncClient::class)
            ->setMethods(['sendRequest'])
    ...
    {
        $json     = file_get_contents(__DIR__ . 'DatabaseTest.php/' . $this->fixturesFolder . '/get-database-filtered.json');
        $jsonObj  = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $dataSyncClientMock = $this->getMockBuilder(DataSyncClient::class)
            ->setMethods(['sendRequest'])
    ...
    {
        $json     = file_get_contents(__DIR__ . 'DatabaseTest.php/' . $this->fixturesFolder . '/create-database.json');
        $jsonObj  = json_decode($json);
        $response = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $dataSyncClientMock = $this->getMockBuilder(DataSyncClient::class)
            ->setMethods(['sendRequest'])
