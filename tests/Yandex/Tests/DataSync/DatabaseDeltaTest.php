...
class DatabaseDeltaTest extends TestCase
{
    ...
    function testSaveDeltaResponse()
    {
        ...
        $databaseId = 'test';
        $revision   = 2;
        $json       = file_get_contents(__DIR__ . 'DatabaseDeltaTest.php/' . $this->fixturesFolder . '/save-delta.json');
    ...
    function testSaveDeltaFilteredResponse()
    {
        ...
        $revision   = 5;
        $fields     = ['href'];
        $json       = file_get_contents(__DIR__ . 'DatabaseDeltaTest.php/' . $this->fixturesFolder . '/save-delta-filtered.json');
    ...
    function testGetDeltaResponse()
    {
        ...
        $fields       = [];
        $limit        = 100;
        $json         = file_get_contents(__DIR__ . 'DatabaseDeltaTest.php/' . $this->fixturesFolder . '/get-delta.json');
    ...
    function testGetDeltaFilteredResponse()
    {
        ...
        $fields       = ['items'];
        $limit        = 100;
        $json         = file_get_contents(__DIR__ . 'DatabaseDeltaTest.php/' . $this->fixturesFolder . '/get-delta-filtered.json');
        $response     = new Response(200, [], \GuzzleHttp\Psr7\stream_for($json));
        $dataSyncClientMock = $this->getMockBuilder(DataSyncClient::class)
            ->setMethods(['sendRequest'])
            ->getMock();
