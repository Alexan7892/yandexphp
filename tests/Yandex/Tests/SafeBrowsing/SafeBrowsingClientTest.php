...
class SafeBrowsingClientTest extends TestCase
{
    ...
    public function testSearchUrlFoundAndMatched()
    {
        $content              = file_get_contents(
            __DIR__ . 'SafeBrowsingClientTest.php/' . $this->fixturesFolder . '/search-url-found-response.txt'
        );
    ...
    public function testPrepareDownloadsRequestSavedChunks()
    {
        ...
        $chunk                = file_get_contents(
            __DIR__ . 'SafeBrowsingClientTest.php/' . $this->fixturesFolder . '/get-chunk-by-url-response.txt'
        );
        $chunksResponse       = file_get_contents(__DIR__ . 'SafeBrowsingClientTest.php/' . $this->fixturesFolder . '/get-chunks-response.txt');
